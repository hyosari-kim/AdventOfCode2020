...
var input = Fs.readFileSync("input/Week3/Year2020Day7.sample.txt", "utf8");
  ...
  if (key !== null && bags !== null) {
    return {
            ...
            bags: Belt_Array.keepMap(Belt_Array.map(Belt_Array.keepMap(bags, (function (bag) {
                    ...
                    var num = bag[0];
                    var name = bag[1];
                    return Caml_option.some(Belt_Option.map(Belt_Int.fromString(num), (function (n) {
                                      return [
                                              n,
                                              name
                                            ];
...
function search(rule, keyword) {
  return Belt_Array.reduce(rule.bags, 0, (function (acc, bag) {
                ...
                var name = bag[1];
                var rule = Belt_Array.getExn(Belt_Array.keep(rules, (function (r) {
                            return r.key === name;
                          })), 0);
                return acc + (
                        name === keyword ? 1 : search(rule, keyword)
                      ) | 0;
              }));
}
...
function search2(rule) {
  return Belt_Array.reduce(rule.bags, 0, (function (acc, bag) {
                ...
                return (acc + cnt | 0) + Math.imul(cnt, search2(rule)) | 0;
              }));
}
